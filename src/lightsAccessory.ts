...
export class LightsAccessory {
  ...
  constructor(
    ...
    this.service.setCharacteristic(this.platform.Characteristic.Name, "Lights");
  ...
  getOn(callback: CharacteristicGetCallback) {
    if (!this.platform.isCurrentlyConnected()) {
      ...
      const isOn = this.platform.spa!.getIsLightOn(this.lightNumber);
      this.platform.log.debug('Get Lights', this.lightNumber, (isOn ? "On" : "Off"), this.platform.status());
      callback(null, isOn);
    }
  }
}